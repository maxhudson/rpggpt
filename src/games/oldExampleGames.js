...
//     "Pick Flowers": {},
//     // "Travel": {},
//     // "Cast": {} //multiple specialties available
//     //magic Paint brush
//   },
//   items: {
//     // "White Robe": {oneOfAKind: true}, //white, gray, and black

//     "The Brush": {oneOfAKind: true, },
...
// export const ghostFarmer = {
//   definition: {
//     title: "Ghost Farmer",
//     description: "Word of a Ghost Town reaches ",
//     plot: [
...
//     },
//     plants: {
//       "Apple Tree": {waterPerDay: 1, daysToMaturity: 5, output: "Apple", seedCost: 10},

//       "Corn Plant": {waterPerDay: 1, costsPerDay: {"Water": 1}, },
//       "Tomato Plant": {waterPerDay: 1, costsPerDay: {"Water": 1}},
//       "Lettuce Plant": {waterPerDay: 1, costsPerDay: {"Water": 1}},
//       "Bean Plant": {waterPerDay: 1, costsPerDay: {"Water": 1}},
//       "Potato Plant": {waterPerDay: 1, costsPerDay: {"Water": 1}},
//     },
//     items: {
//       "Apple": {},
//       "Apple Seed": {},
...
//       "Corn": {},
//       "Corn Seed": {cost: {"Coins": 3}},

//       "Tomato": {},
//       "Tomato Seed": {cost: {"Coins": 3}},
...
//       "Stew": {actions: {
//         "Craft": {cost: {timeInMinutes: 30, items: {"Water": 2, "Potato": 2, "Carrot": 1, "Meat": 1}}}},
//         "Sell": {value: 15},
//         "Buy": {cost: 20}
//       }},
//     },
//     "Buildings": {
//       "Well": {
//         notes: "Outputs 1000 water/day which first fills up well storage, then overflows to Water Tank if available",
//         maxStorage: {"Water": {amount: 1000}}
//       },
//       "Water Tank": {
//         notes: "Takes 4 days to build",
//         maxStorage: {"Water": {amount: 5000, additionalAmountPerLevel: 1000}, maxLevel: 5}
//       },

//       "Tent": {
//         notes: "Time efficiency of actions that require time is 0.5x for the character living here.",
//         actions: {
//           "Move In": {housingCapacity: 1}, //create default instance with charactersLivingHere: []
//           "Build": {timeInMinutes: 60, cost: {"Wood": 4, }},
//           "Deconstruct": {timeInMinutes: 30, output: {}}
//         },
//       },
//       "Cabin": {
//         actions: {
//           "Move In": {housingCapacity: {amount: 1, additionalAmountPerLevel: 1}, maxLevel: 3},
//           "Build": {timeInMinutes: 60, cost: {"Lumber": 100}},
//           "Deconstruct": {timeInMinutes: 30, output: {}}
//         }, },
//       },
//       // "Chicken Coop": {buildTimeInHours: 100, maxLevel: 5, output: {"Egg": {freq: "daily", amount: 2, additionalAmountPerLevel: 2}}},
//       // "Food Storage": {},
//       //crafting - food, tools
//       // unlockConditions
...
//     },
//     characters: {
//       // Samuel "Sam" Wells - Prospector
//       // Martha Greene - Farmer
//       // Jacob Turner - Carpenter
//       // Thomas "Tom" Reed - Blacksmith
//       // Rosa Martinez - Cook
//       // Henry Chen - Water Engineer
//       // Elizabeth "Liz" Crawford - Merchant
//       // Dr. William Hayes - Doctor
//       // Jesse Morrow - Scout
//       "Sam Wells": {notes: "Prospector", instance: {stats: {"Use Tool": 10}}, requiresHousing: true},
//       "Martha Greene": {notes: "Farmer", instance: {stats: {"Planting": 10, "Harvesting": 10}}, requiresHousing: true},
//     },
//     settings: {
...
//   instance: {
//     clock: {day: 1, time: [8, 0, "am"]},
//     weather: {condition: "clear", high: 75, low: 55 },
//     activeLocation: "Campground",
//     activeCharacter: "",
//     storyText: "",
//     water: 0,
//     money: 100,
...
//     ],
//     characters: {
//       //character x - 4 hours remaining on task
//     }
//   }
// };
